	...
	const handleSubmit = useCallback(async (data: ForgotPasswordFormData) => {
		try {
			...
			addToast({
				...
				description: 'Enviamos um e-mail para confirmar a recuperação de senha, check a sua caixa de entrada.',
			});
		} catch (err) {
			...
			<Content>
				<AnimationContainer>
					...
					<Form ref={formRef} onSubmit={handleSubmit}>
						...
						<Button loading={Number(!!loading)} type="submit">Recuperar</Button>
					</Form>
